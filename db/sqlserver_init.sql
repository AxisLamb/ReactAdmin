...
INSERT [dbo].[sys_menu] ([menu_id], [parent_id], [name], [url], [react_component], [perms], [type], [icon], [order_num], [created_by], [create_time], [updated_by], [update_time]) VALUES (44, 1, N'文件管理', N'sys/file', N'FileList', N'oss:file:list', 1, N'file-image', 3, NULL, NULL, NULL, NULL)
