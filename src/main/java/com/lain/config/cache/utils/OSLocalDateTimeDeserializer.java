...
import static com.lain.common.utils.DateUtils.*;
...
public class OSLocalDateTimeDeserializer extends JSR310DateTimeDeserializerBase<LocalDateTime> {
    public static final OSLocalDateTimeDeserializer INSTANCE = new OSLocalDateTimeDeserializer();
    ...
    private OSLocalDateTimeDeserializer() {
        this(DEFAULT_FORMATTER);
    }

    public OSLocalDateTimeDeserializer(DateTimeFormatter formatter) {
        super(LocalDateTime.class, formatter);
    }

    protected OSLocalDateTimeDeserializer(OSLocalDateTimeDeserializer base, Boolean leniency) {
        super(base, leniency);
    }
    ...
    @Override
    protected OSLocalDateTimeDeserializer withLeniency(Boolean leniency) {
        return new OSLocalDateTimeDeserializer(this, leniency);
    }
