package com.lain.config.cache;

import cn.hutool.core.text.StrPool;
import com.google.common.collect.Maps;
import com.lain.config.cache.lock.DistributedLock;
import com.lain.config.cache.lock.RedisDistributedLock;
import com.lain.config.cache.properties.CustomCacheProperties;
import com.lain.config.cache.properties.SerializerType;
import com.lain.config.cache.redis2.RedisOps;
import com.lain.config.cache.repository.CacheOps;
import com.lain.config.cache.repository.CachePlusOps;
import com.lain.config.cache.repository.impl.RedisOpsImpl;
import com.lain.config.cache.utils.ProtoStuffSerializer;
import com.lain.config.cache.utils.RedisObjectSerializer;
