...
public final class DateUtils {
    ...
    public static final String DEFAULT_DATE_TIME_WITHOUT_SEPARATOR = "yyyyMMddHHmmss";
    public static final String TAMS_DATE_TIME_FORMAT = "dd/MM/yyyy HH:mm:ss";
    public static final String TAMS_DATE_FORMAT = "dd/MM/yyyy";
    public static final String TAMS_TIME_FORMAT = "HH:mm";
    public static final String TAMS_DATE_FORMAT_MATCHES = "^\\d{2}/\\d{2}/\\d{4}$";
    ...
    static {
        ...
        LOCAL_DATE_FORMAT_MAP.put(TAMS_DATE_FORMAT, TAMS_DATE_FORMAT_MATCHES);
...
//--格式化日期start-----------------------------------------
    ...
    static {
        ...
        DATE_FORMAT.put(TAMS_DATE_FORMAT, TAMS_DATE_FORMAT_MATCHES);
    }
    ...
    public static LocalDate parse(String source) {
        ...
        throw new LainException("解析日期失败, 请传递正确的日期格式");
    }
    ...
    public static Date parseAsDateTime(String dateTime) {
        Function<String, Date> function = format -> {
            try {
                ...
                throw new LainException(e.getMessage(), e);
            }
        };
    ...
    public static String calculation(LocalDate startDate, LocalDate endDate, List<String> dateList) {
        ...
        if (day >= 0 && day <= MAX_MONTH_DAY) {
            ...
            throw new LainException("日期参数只能介于0-365天之间");
        }
        return dateType;
    }
...
//----------//----------//----------//----------//----------//----------//----------//----------//----------//----------//----------
    ...
    public static Date mergeDate(Date date,Date time){
        Date rst = mergeDateWithSecond(date, time);
        if(rst == null){
            return null;
        }
    ...
    public static Date mergeDateWithSecond(Date date,Date time){
    ...
    public static String formatTimestamp(long timestamp) {
        return formatTimestamp(timestamp, TAMS_DATE_TIME_FORMAT);
    }
